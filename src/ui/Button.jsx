...
export default function Button({children, type}) {
    ...
    const styles = {
        ...
        small: "px-8 py-1 border-2 border-amber-700 text-amber-700 text-[0.8rem] mb-4 transition-all duration-500 disabled:cursor-not-allowed inline-block tracking-wide cursor-pointer hover:text-white/90 hover:bg-amber-700 duration-500 cursor-pointer md:hidden"
    }
