...
export default function Button({children, type}) {
    ...
    const styles = {
        ...
        flat: 'px-12 py-3 border-2 border-amber-700 text-amber-700 text-sm transition-all duration-500 disabled:cursor-not-allowed inline-block tracking-wide cursor-pointer hover:text-white/90 hover:bg-amber-700 duration-500 cursor-pointer',
