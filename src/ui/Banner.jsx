...
export default function Banner() {
  return (
    <div className='relative bg-[#fff] mx-[14px] shadow-2xl mt-4 mb-8 md:mb-24 pb-6 md:mt-[-64px] lg-[-78px] md:mr-[64px] md:ml-[48px] lg:mr-[128px] lg:ml-24 px-6 md:px-10 lg:px-24'>
        <div className='flex flex-col md:flex-row'>
          <div className='pt-12 w-full md:w-1/3'>
            <p className='font-bold text-center md:text-start pb-4'>About Me</p>
