                      ...
                      <img className='hidden md:flex md:max-w-[240px] rounded-md' src={succy} alt="" />
                        <div className='items-center text-gray-600 justify-center m-auto'>  
                              <p className='text-[15px] font-semibold pb-4 text-justify'>
                                Hi, I’m SUCCESS CHRISTOPHER, the artist behind Glam by La Sauce. I’m passionate about creating looks that highlight your natur`al beauty while reflecting your personal style. From soft glam to bold transformations, my goal is to make you feel confident, radiant, and uniquely you—one brush stroke at a time.</p>
