  ...
  return (
    <div className='px-6 md:px-10 lg:px-24'>
      ...
      <div className='flex flex-col md:flex-row mb-20'>
        ...
        <div className='border px-10 md:px-16 py-8 sm:py-16 flex flex-col gap-5 text-[15px] hover:bg-red-200 hover:text-red-700 focus:bg-red-200 focus:text-red-500 duration-500 text-gray-600 cursor-pointer'>
        <b>PERSONALIZATION:</b>
